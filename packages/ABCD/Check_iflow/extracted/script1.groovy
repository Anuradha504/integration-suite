<?xml version="1.0" encoding="UTF-8"?><bpmn2:definitions xmlns:bpmn2="http://www.omg.org/spec/BPMN/20100524/MODEL" xmlns:bpmndi="http://www.omg.org/spec/BPMN/20100524/DI" xmlns:dc="http://www.omg.org/spec/DD/20100524/DC" xmlns:di="http://www.omg.org/spec/DD/20100524/DI" xmlns:ifl="http:///com.sap.ifl.model/Ifl.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" id="Definitions_1">
    ...
    <bpmn2:process id="Process_1" name="Integration Process">
        ...
        <bpmn2:endEvent id="EndEvent_7" name="End 1">
            <bpmn2:extensionElements>
                <ifl:property>
                    <key>componentVersion</key>
                    <value>1.1</value>
        ...
        <bpmn2:callActivity id="CallActivity_4" name="Content Modifier 1">
            <bpmn2:extensionElements>
                ...
                <ifl:property>
                    <key>wrapContent</key>
                    <value>hello updated by rakesh</value>
                </ifl:property>
                <ifl:property>
                    <key>componentVersion</key>
                    <value>1.6</value>
        ...
        <bpmn2:callActivity id="CallActivity_6" name="Content Modifier 2">
            <bpmn2:extensionElements>
                <ifl:property>
                    <key>bodyType</key>
                    <value>constant</value>
                ...
                <ifl:property>
                    <key>wrapContent</key>
                    <value>test for version &amp; comments</value>
                </ifl:property>
                <ifl:property>
                    <key>componentVersion</key>
                    <value>1.6</value>
        ...
        <bpmn2:sequenceFlow id="SequenceFlow_5" sourceRef="CallActivity_4" targetRef="CallActivity_6"/>
        <bpmn2:sequenceFlow id="SequenceFlow_8" sourceRef="CallActivity_6" targetRef="EndEvent_7"/>
    ...
    <bpmndi:BPMNDiagram id="BPMNDiagram_1" name="Default Collaboration Diagram">
        <bpmndi:BPMNPlane bpmnElement="Collaboration_1" id="BPMNPlane_1">
            ...
            <bpmndi:BPMNShape bpmnElement="EndEvent_7" id="BPMNShape_EndEvent_7">
                <dc:Bounds height="32.0" width="32.0" x="974.0" y="170.0"/>
            </bpmndi:BPMNShape>
            <bpmndi:BPMNShape bpmnElement="Participant_Process_1" id="BPMNShape_Participant_Process_1">
                <dc:Bounds height="267.0" width="1004.0" x="158.0" y="36.0"/>
            </bpmndi:BPMNShape>
            <bpmndi:BPMNEdge bpmnElement="SequenceFlow_5" id="BPMNEdge_SequenceFlow_5" sourceElement="BPMNShape_CallActivity_4" targetElement="BPMNShape_CallActivity_6">
                <di:waypoint x="501.0" xsi:type="dc:Point" y="170.0"/>
                <di:waypoint x="718.0" xsi:type="dc:Point" y="170.0"/>
            </bpmndi:BPMNEdge>
            <bpmndi:BPMNEdge bpmnElement="SequenceFlow_8" id="BPMNEdge_SequenceFlow_8" sourceElement="BPMNShape_CallActivity_6" targetElement="BPMNShape_EndEvent_7">
                <di:waypoint x="718.0" xsi:type="dc:Point" y="181.0"/>
                <di:waypoint x="990.0" xsi:type="dc:Point" y="181.0"/>
            </bpmndi:BPMNEdge>
            <bpmndi:BPMNEdge bpmnElement="SequenceFlow_3" id="BPMNEdge_SequenceFlow_3" sourceElement="BPMNShape_StartEvent_2" targetElement="BPMNShape_CallActivity_4">
                <di:waypoint x="264.0" xsi:type="dc:Point" y="173.0"/>
                <di:waypoint x="501.0" xsi:type="dc:Point" y="173.0"/>
            </bpmndi:BPMNEdge>
        </bpmndi:BPMNPlane>
    </bpmndi:BPMNDiagram>
</bpmn2:definitions>